	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		$.prettyPhoto.initialize = function() {
			...
			if(settings.theme == 'dark_square') settings.horizontal_padding = 16;
			if(settings.ie6_fallback && $.browser.msie && parseInt($.browser.version) == 6) settings.theme = "dark_square"; // Fallback to a supported theme for IE6
		...
		*/
		$.prettyPhoto.open = function(event) {
			if(typeof settings == "undefined"){ // Means it's an API call, need to manually get the settings and set the variables
				settings = pp_settings;
				if($.browser.msie && $.browser.version == 6) settings.theme = "dark_square"; // Fallback to a supported theme for IE6
